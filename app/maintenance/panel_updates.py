...
GITHUB_REPO = os.getenv("SG_GATEWAY_UPDATE_REPO", "s-gor/sg-gateway-v23").strip() or "s-gor/sg-gateway-v23"
GITHUB_BRANCH = os.getenv("SG_GATEWAY_UPDATE_BRANCH", "stable-02301").strip() or "stable-02301"
